...
class ProjectArticleAdapter(private val fragment: Fragment, private val projectArticleList: List<ProjectArticle>)
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.project_article_item,parent,false)
